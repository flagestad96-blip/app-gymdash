...
const program: TranslationMap = {
  ...
  "program.manage": "Manage program",
  "program.manageDesc": "Rename, duplicate, periodization, sharing and more.",
  "program.exercisesCount": "{n} exercises",
  ...
  "program.chooseExerciseA": "Choose exercise A",
  "program.chooseExerciseSlotB": "Choose exercise B",
  "program.chooseExerciseSlotC": "Choose third exercise (optional)",
  "program.chooseExerciseB": "Choose exercise B (A is {name}).",
  "program.chooseExerciseCHint": "Add a third exercise to A: {a} / B: {b}, or finish as a 2-way superset.",
  "program.finishTwoWay": "Save as 2-way superset",
  "program.swapExercise": "Swap exercise",
  "program.swapAB": "Swap A ↔ B",
  "program.addThird": "Add third exercise",
  "program.removeC": "Remove third",
  "program.renameDay": "Rename day",
  "program.dayNamePlaceholder": "e.g. Push, Pull, Legs",
