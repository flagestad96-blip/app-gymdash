...
const analysis: TranslationMap = {
  ...
  "analysis.pushPull": "Push/pull: {push}:{pull} sets",
  "analysis.pushPullBalanced": "balanced",
  "analysis.pushPullMorePull": "consider more pulling (back/biceps)",
  "analysis.pushPullMorePush": "consider more pressing (chest/shoulders)",
  "analysis.setRangeNote": "Guideline: ~6\u201310 hard sets per muscle group per week, 8\u201312 for big groups.",
