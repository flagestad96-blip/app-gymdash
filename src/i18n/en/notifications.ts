...
const notifications: TranslationMap = {
  ...
  "notifications.restCountdownTitle": "Resting",
  "notifications.restCountdownBody": "Counting down to your next set",
  "notifications.restCountdownChannel": "Rest countdown",
