...
const settings: TranslationMap = {
  ...
  "settings.palette.desc": "Pick an accent palette.",
  "settings.palette.aurora": "Aurora",
  "settings.palette.violet": "Violet",
  "settings.palette.emerald": "Emerald",
  "settings.palette.sunset": "Sunset",
  "settings.glass.desc": "Glass intensity",
  "settings.glass.low": "Subtle",
  "settings.glass.medium": "Medium",
  "settings.glass.high": "Strong",
  ...
  "settings.superset.transitionRest": "Rest between slots within a round",
  "settings.superset.transitionRestDesc": "Short rest when switching exercise inside the same round. Full rest is used between rounds.",
  "settings.superset.transitionRestNone": "Off",
  "settings.backup": "BACKUP",
  "settings.autoBackup": "Automatic backup",
  "settings.autoBackup.desc": "Backs itself up — daily and after every workout.",
  "settings.autoBackup.folder": "Folder: {folder}",
  "settings.autoBackup.iosLocation": "Stored in the app's documents folder.",
  "settings.autoBackup.lastRun": "Last backup: {when}",
  "settings.autoBackup.neverRun": "No backup taken yet.",
  "settings.autoBackup.keepNote": "Keeps the {n} newest.",
  "settings.autoBackup.changeFolder": "Change folder",
  "settings.autoBackup.folderNeeded": "Pick a folder for the backups — ideally one a cloud app syncs (Drive, Dropbox etc.), so your data also survives a lost phone.",
  "settings.autoBackup.failed": "Could not save the backup. Check that the folder still exists, or pick a new one.",
