...
const settings: TranslationMap = {
  ...
  "settings.appearance.palette": "Aurora palette",
  "settings.appearance.palette.desc": "The four accent colors behind the glass.",
  "settings.appearance.palette.aurora": "Aurora",
  "settings.appearance.palette.violet": "Violet",
  "settings.appearance.palette.emerald": "Emerald",
  "settings.appearance.palette.sunset": "Sunset",
  "settings.appearance.intensity": "Glass intensity",
  "settings.appearance.intensity.desc": "How frosted the panels feel (0–100).",
  "settings.focus": "YOUR FOCUS",
  "settings.focus.desc": "What you picked in onboarding. The Home screen promotes the section that matches your primary goal.",
  "settings.focus.trainingDays": "Training days per week",
  "settings.focus.goals": "Goals",
  "settings.focus.replayOnboarding": "Replay onboarding",
