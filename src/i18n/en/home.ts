...
const home: TranslationMap = {
  ...
  "home.resumeWorkout": "Continue workout",
  "home.resumeWorkoutWithDay": "You have an unfinished workout ({day}). Tap to continue logging.",
  "home.resumeWorkoutBare": "You have an unfinished workout. Tap to continue logging.",
