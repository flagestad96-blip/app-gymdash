...
const analysis: TranslationMap = {
  ...
  "analysis.emptyState": "Fullf\u00f8r din f\u00f8rste \u00f8kt for \u00e5 se statistikk her.",
  ...
  "analysis.pushPull": "Push/pull: {push}:{pull} sett",
  "analysis.pushPullBalanced": "balansert",
  "analysis.pushPullMorePull": "vurder mer draging (rygg/biceps)",
  "analysis.pushPullMorePush": "vurder mer pressing (bryst/skuldre)",
  "analysis.setRangeNote": "Retningslinje: ~6\u201310 harde sett per muskelgruppe i uka, 8\u201312 for store grupper.",
  ...
  "analysis.insight.decliningFatigued": "Styrken synker \u2014 vurder hvile eller en deload-uke.",
