...
const settings: TranslationMap = {
  ...
  "settings.palette.desc": "Velg en aksentpalett.",
  "settings.palette.aurora": "Aurora",
  "settings.palette.violet": "Fiolett",
  "settings.palette.emerald": "Smaragd",
  "settings.palette.sunset": "Solnedgang",
  "settings.glass.desc": "Glass-intensitet",
  "settings.glass.low": "Subtil",
  "settings.glass.medium": "Medium",
  "settings.glass.high": "Sterk",
  ...
  "settings.superset.transitionRest": "Hvile mellom slots i runde",
  "settings.superset.transitionRestDesc": "Kort hvile n\u00e5r du bytter \u00f8velse innen samme runde. Full hvile brukes mellom runder.",
  "settings.superset.transitionRestNone": "Av",
  "settings.backup": "BACKUP",
  "settings.autoBackup": "Automatisk sikkerhetskopi",
  "settings.autoBackup.desc": "Tar full kopi av seg selv — daglig og etter hver økt.",
  "settings.autoBackup.folder": "Mappe: {folder}",
  "settings.autoBackup.iosLocation": "Lagres i appens dokumentmappe.",
  "settings.autoBackup.lastRun": "Siste kopi: {when}",
  "settings.autoBackup.neverRun": "Ingen kopi tatt ennå.",
  "settings.autoBackup.keepNote": "Beholder de {n} nyeste.",
  "settings.autoBackup.changeFolder": "Bytt mappe",
  "settings.autoBackup.folderNeeded": "Velg en mappe for sikkerhetskopiene — gjerne en som synkroniseres til sky (Drive, Dropbox e.l.), så overlever dataene også en mistet telefon.",
  "settings.autoBackup.failed": "Kunne ikke lagre sikkerhetskopi. Sjekk at mappen fortsatt finnes, eller velg en ny.",
