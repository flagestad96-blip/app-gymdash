...
const settings: TranslationMap = {
  ...
  "settings.appearance.palette": "Aurora-palett",
  "settings.appearance.palette.desc": "De fire aksentfargene bak glasset.",
  "settings.appearance.palette.aurora": "Aurora",
  "settings.appearance.palette.violet": "Lilla",
  "settings.appearance.palette.emerald": "Smaragd",
  "settings.appearance.palette.sunset": "Solnedgang",
  "settings.appearance.intensity": "Glass-intensitet",
  "settings.appearance.intensity.desc": "Hvor frostete panelene f\u00f8les (0–100).",
  "settings.focus": "DITT FOKUS",
  "settings.focus.desc": "Valgene du gjorde i onboarding. Hjem-skjermen l\u00f8fter seksjonen som matcher hovedm\u00e5let ditt.",
  "settings.focus.trainingDays": "Treningsdager per uke",
  "settings.focus.goals": "M\u00e5l",
  "settings.focus.replayOnboarding": "Spill av onboarding p\u00e5 nytt",
