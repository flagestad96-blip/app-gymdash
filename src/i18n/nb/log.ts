...
const log: TranslationMap = {
  ...
  "log.supersetLogNext": "Logg sett {slot} → bytt til {next}",
  "log.supersetLogFinishRound": "Logg sett {slot} → fullfør runde {n}",
  "log.supersetLogFinishSuperset": "Logg sett {slot} → fullfør supersett",
