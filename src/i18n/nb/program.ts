...
const program: TranslationMap = {
  ...
  "program.manage": "Administrer program",
  "program.manageDesc": "Gi nytt navn, dupliser, periodisering, deling og mer.",
  "program.exercisesCount": "{n} øvelser",
  ...
  "program.chooseExerciseA": "Velg \u00f8velse A",
  "program.chooseExerciseSlotB": "Velg \u00f8velse B",
  "program.chooseExerciseSlotC": "Velg tredje \u00f8velse (valgfri)",
  "program.chooseExerciseB": "Velg \u00f8velse B (A er {name}).",
  "program.chooseExerciseCHint": "Legg til en tredje \u00f8velse til A: {a} / B: {b}, eller fullf\u00f8r som 2-veis supersett.",
  "program.finishTwoWay": "Lagre som 2-veis supersett",
  "program.swapExercise": "Bytt \u00f8velse",
  "program.swapAB": "Bytt A \u2194 B",
  "program.addThird": "Legg til tredje \u00f8velse",
  "program.removeC": "Fjern tredje",
  "program.renameDay": "Gi dagen navn",
  "program.dayNamePlaceholder": "f.eks. Push, Pull, Bein",
