...
export async function computeTrainingStatus(
  ...
  if (!resolvedProgramId) {
    try {
      ...
      console.warn("trainingStatus: failed to resolve programId", e);
    }
  }
  ...
  if (resolvedProgramId) {
    try {
      ...
      console.warn("trainingStatus: failed to check periodization", e);
    }
  }
  ...
  const sessionCount = (() => {
    try {
      ...
      console.warn("trainingStatus: failed to count sessions", e);
      return 0;
    }
  })();
  ...
  try {
    ...
    console.warn("trainingStatus: e1RM trend failed", e);
  }
  ...
  try {
    ...
    console.warn("trainingStatus: RPE drift failed", e);
  }
  ...
  try {
    ...
    console.warn("trainingStatus: volume trend failed", e);
  }
  ...
  if (resolvedProgramId && topExerciseIds.length > 0) {
    try {
      ...
      console.warn("trainingStatus: rep consistency failed", e);
    }
  }
